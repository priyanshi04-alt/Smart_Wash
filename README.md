...
![Real-Time Tracking](screenshots/student-dashboard.png)
...
## 👤 Student Profile & QR Tags

Students can view their profile information and manage their reusable laundry QR tags.
...
## 🏷️ Laundry ID & QR Tag Management

Administrators can manage Laundry IDs and allocate reusable QR tags to students and their clothing.

![QR Tag Management](screenshots/qr-tags.png)
...
Administrators can monitor laundry requests, scanned tags, item counts, fees, dates, and current processing status.

![Laundry Monitoring](screenshots/monitoring.png)
